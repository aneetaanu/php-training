	...
	if (isset($_GET['id'])) {
		$id = $_GET['id'];
		$record =  "SELECT * FROM anu1 WHERE id= '".$id."'";
...
if(empty($_POST['uname'])){
	...
	if($_POST["fname"]!='' && $_POST["lname"]!='' && $_POST["email"]!='' && $_POST["uname"]!='' && $_POST["gender"] !=''){
	   ...
	   $sql ="UPDATE anu1 SET fname ='".$_POST['fname']."', lname ='".$_POST['lname']."', email = '".$_POST['email']."', uname = '".$_POST['uname']."', gender = '".$_POST['gender']."', image='".$_FILES['image']['name']."' WHERE id = '".$id."'";	
	 ...
	 $sql ="UPDATE anu1 SET fname ='".$_POST['fname']."', lname ='".$_POST['lname']."', email = '".$_POST['email']."', uname = '".$_POST['uname']."', gender = '".$_POST['gender']."',image='".$row['image']."' WHERE id = '".$id."'";
